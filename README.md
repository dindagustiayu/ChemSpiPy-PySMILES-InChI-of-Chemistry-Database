...
1. _SMILES_ [`Simplified Molecular-Input Line-Entry System`](https://pypi.org/project/pysmiles/)
2. _SMART_ [`Smiles Arbitary Target Specification`](https://www.daylight.com/dayhtml/doc/theory/theory.smarts.html)
3.  _XYZ_ [`XYZ-py`](https://pypi.org/project/xyz-py/0.0.23/)
4. _Molfile_ [`MDL Molfile`](https://www.biotite-python.org/latest/apidoc/biotite.structure.io.mol.MOLFile.html)
5. _Chemical Markup Language format based on Extensible Markup Language_ [`XML-based formats`](https://www.xml-cml.org/)
6. _InChI and InChIkey_ [`The international Chemical Identifier`](https://www.inchi-trust.org/)
...
![Standard InChI](https://chem.libretexts.org/@api/deki/files/202932/InChI%252BLayers.JPG?revision=1)

Reference: [Line Notation SMILES and InChI](https://chem.libretexts.org/Courses/Fordham_University/Chem1102%3A_Drug_Discovery_-_From_the_Laboratory_to_the_Clinic/05%3A_Organic_Molecules/5.08%3A_Line_Notation_(SMILES_and_InChI))
